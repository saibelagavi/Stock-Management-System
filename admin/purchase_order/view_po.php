...
echo $currentDate;?>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="remarks" class="control-label text-info">Supplier Address</label>
            ...
            <table class="table table-striped table-bordered" id="list">
                ...
                <tbody>
                    <?php 
                    $total = 0;
                    $qry = $conn->query("SELECT i.name,i.description,p.* FROM `po_items` p inner join item_list i on p.item_id = i.id where p.po_id = '{$id}'");
                    ...
                    <?php echo $row['name'] ?> <br>
                        ...
                        <td class="py-1 px-2 text-center"><?php echo number_format($row['quantity']) ?>
             ...
             <div class="row">
                <!-- <div class="col-md-6">
                <label for="adress" class="text-info control-label">Customer Address:</label>
    ...
    $(function(){
        $('#print').click(function(){
            ...
            _el.append('<div class="d-flex justify-content-center">'+
                      ...
                      '<h1 class="text-center"><strong><?php echo $_settings->info('name') ?></strong></h1>'+
