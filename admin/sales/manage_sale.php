            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="address" class="form-control form-control-sm rounded-0" value="<?php echo isset($address) ? $address : '' ?>" >
                        </div>
                    </div>
                </div>
                <hr>
                ...
                <table class="table table-striped table-bordered" id="list">
                    ...
                    <tr>
                        ...
                        <tr>
                            <th class="text-right py-1 px-2" colspan="5">GST <input style="width:40px !important" name="tax_perc" class='' type="number" min="0" max="100" value="<?php echo isset($tax_perc) ? $tax_perc : 0 ?>">%
